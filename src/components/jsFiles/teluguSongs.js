export const teluguSongs = [
    ...
    {
        teluguTitle: 'ఆగని పరుగులో ఎండిన ఎడారులు',
        englishTitle: 'aagani parugulo endina edaarulu',
        teluguLyric: 'ఆగని పరుగులో ఎండిన ఎడారులు\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=T8NokLjA0zo'
    },
    {
        teluguTitle: 'ఆగిపోదు నా పాట గమ్యం చేరేదాక',
        englishTitle: 'aagipodhu na pata',
        teluguLyric: 'ఆగిపోదు నా పాట - గమ్యం చేరేదాక\n' +
    ...
    {
        teluguTitle: 'ఆచరించుచునున్నాము ఆ చందము మేము',
        englishTitle: 'aacharimchuchununnaamu aa chmd',
        teluguLyric: 'ఆచరించుచునున్నాము ఆ చందము మేము యే చందమేసు ప్రభు\n' +
            'సెల విచ్చివేంచేసితో పరమండలికి ||ఆచరించు||\n' +
            '\n' +
            '1. నీ సుభక్తుల్ నిస్తులాపొస్తలుల్ నీ సెలవున న్నిఖిల భూస్థులుల్ వాసికెక్కగా\n' +
            'గాఁజేయుటకు వ్యాపించిరి కోరి యోసియ్యోను రాజశాశ్వత శ్రీసనాధ\n' +
            'శ్రితరక్షభాజ నీ సుదయచే నీ యుద్యోగము నిత్యంబును బొంది\n' +
            '||యాచరించు||\n' +
            '\n' +
            '\n' +
            '2. భాసురత్వత్సమా చార వాక్యము విని సదావి శ్వాసిభాగ్యాభి ముఖ\n' +
            'స్వాభావుల నీవేళన్ భాసమాన పతితపా వనతాంకిత పాత్ర దరికు\n' +
            'ల్లాసము నెమ్మోములందు రాజిల్లగం దెచ్చి ||యాచరించు||\n' +
            '\n' +
            '\n' +
            '3. పరిశుద్ధ నాధ్యాత్మ మోక్ష పారావతమా వీరి నిత్తరి నరుదౌ\n' +
            'నీదైవత్వచి హ్నముతోడను గూడ సరవిగా దతియను బొందె దెరగున\n' +
            'నీబప్తి స్తోదకములయు బరిని వ్యాపించియుండుటకు ప్రార్థించుచు నిన్ను\n' +
            '||యాచరించు||\n' +
            '\n' +
            '\n' +
            '4. పరయానంద వదనము నీ దరికరాఁగిగోరు వీరి న్నీ పరమ కృపన్\n' +
            'దీవించి నీ కరుణా కటాక్షేక్షన్ స్థిరతఁ బాంచియాత్మలకు నీ మహిమ\n' +
            'కిరణములు నెరపు మో అభువాయని నిన్ను వేడుచు ||నాచరించు||',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆడజన్మను దేవుడు ఎందుకు చేశాడు',
        englishTitle: 'aada janmanu devudu enduku chesaadu',
        teluguLyric: 'ఆడజన్మను దేవుడు ఎందుకు చేశాడు ?\n' +
            'ఆడ జన్మ అవసరత దేవుడు ఎందుకు తెలిపాడు ?\n' +
            'ఆడజన్మ మనిషికి అర్థమయిందా ?\n' +
            'ఆడ జన్మ అవసరత అర్థం కాకుందా.?\n' +
            'ఆడపిల్ల పుడితే వద్దనుకుంది శిశువును గర్భంలో హతమార్చింది\n' +
            'ఆడజన్మను మనిషి పాడు జన్మ అనుకుంది\n' +
            'అర్థమే లేకుండా అంత మెందిస్తుంది\n' +
            '\n' +
            'ప్రతి 1000 పురుషులకు ఆడవారి సంఖ్య\n' +
            'గణనీయముగా తగ్గిపోయిన దిగా\n' +
            'పురుషులకు స్త్రీ ముఖ్యమని గమనించి\n' +
            'ఆదాముకు అవ్వను అర్ధాంగిగా ఇచ్చి\n' +
            'సాటి అయిన సహాయము కావాలని దేవుడు\n' +
            'పురుషునికి స్త్రీని ఇచ్చి 1 గ జత పరిచాడు\n' +
            'ఆడజన్మ అవసరతను అందరికీ తెలిపాడు\n' +
            '\n' +
            ...
            'పురుషులకి లోకంలో స్త్రీలే కరువవుతారు\n' +
            'ఆడ జన్మకు బ్రతికే అర్హతనే ఉండదు\n' +
            'ఆడవారిని బ్రతికించి కాపాడండి\n' +
            'పురుషులతో సమానముగా పోషించండి\n' +
            '\n' +
            'స్త్రీలు లేనిదే పురుషులు లేరని\n' +
            'పురుషులు లేనిదే స్త్రీలు లేరని\n' +
            'తల్లి కావాలి నీకు చెల్లి కావాలి\n' +
            'అక్క కావాలి కూతురు కావాలి',
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=KTmXMR0Eddk'
    },
    {
        teluguTitle: 'ఆడెదన్ పాడెదన్',
        englishTitle: 'aadedhan paadehan ',
        teluguLyric: 'ఆడెదన్ పాడెదన్\n' +
            '\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆత్మ దీపమును',
        englishTitle: 'aathma deepamunu',
        teluguLyric: 'ఆత్మ దీపమును (2)\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=BH_yM8-8EHs'
    },
    {
        teluguTitle: 'ఆత్మ దీపమును వెలిగించు యేసు ప్రభో ఆత్మ దీపమును',
        englishTitle: 'aathma dheepamunu veligimchu yaesu prabhoa aathma dheepamunu',
        teluguLyric: 'పల్లవి: ఆత్మ దీపమును - వెలిగించు\n' +
    ...
    {
        teluguTitle: 'ఆత్మా నడుపు స త్యము లోని కిపుడ',
        englishTitle: 'aathmaa nadupu sa thyamu loani',
        teluguLyric: 'ఆత్మా నడుపు స త్యము లోని కిపుడే యాత్మా నడుపు ఆత్మా నీ\n' +
            'సాయంబు నధికంబుగా నిచ్చి ఆత్మానందముతో దై వారాధనమున ||కాత్మా||\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆత్మ నియమము ద్వారా సాగి పోవుదము',
        englishTitle: 'aathma niyamamu dhvaaraa saagi poavudhamu',
        teluguLyric: 'పల్లవి: ఆత్మ నియమము ద్వారా - సాగి పోవుదము\n' +
    ...
    {
        teluguTitle: 'ఆత్మ మందిరమును ప్రభు కట్టుచున్నాడు ఆత్మ నియమముతో నిర్మించున్\n',
        englishTitle: 'aathma mmdhiramunu prabhu kattuchunnaadu aathma niyamamuthoa nirmimchun',
        teluguLyric: 'పల్లవి: ఆత్మ మందిరమును - ప్రభు కట్టుచున్నాడు\n' +
            'ఆత్మ నియమముతో - నిర్మించున్\n' +
            '\n' +
            '1. మందిర దర్శన - మాత్మకు నిచ్చి\n' +
            'ఆత్మ ద్వార నే - కన పరచున్\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆత్మ వర్షము మాపై కురిపించుము',
        englishTitle: 'aathma varshamu maapai kuripinchumu',
        teluguLyric: 'ఆత్మ వర్షము మాపై కురిపించుము\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=3T54qJrKXvA'
    },
    {
        teluguTitle: 'ఆత్మ వర్షమును కుమ్మరించయ్యా',
        englishTitle: 'aathma varshamunu kummarinchayyaa',
        teluguLyric: 'ఆత్మ వర్షమును కుమ్మరించయ్యా\n' +
    ...
    {
        teluguTitle: 'ఆత్మ విషయమై దీనులైనవారు ధన్యులు పరలోక రాజ్యము వారిది',
        englishTitle: 'aathma vishyamai dheenulainavaaru dhanyulu paraloaka raajyamu vaaridhi',
        teluguLyric: '1. ఆత్మ విషయమై - దీనులైనవారు\n' +
    ...
    {
        teluguTitle: 'ఆత్మ శృంగారించు కొమ్ము పాప గ',
        englishTitle: 'aathma shrumgaarimchu kommu paapa',
        teluguLyric: '1. ఆత్మ! శృంగారించు కొమ్ము\n' +
            'పాప గుహ వీడి పొమ్ము\n' +
    ...
    {
        teluguTitle: 'ఆత్మపరిశుద్దాత్ముడా నాలో నివసించుము',
        englishTitle: 'atmaparisuddatmuda',
        teluguLyric: 'ఆత్మపరిశుద్దాత్ముడా - నాలో నివసించుము\n' +
    ...
    {
        teluguTitle: 'ఆత్మీయ గానాలతో',
        englishTitle: 'aathmeeya gaanaalatho',
        teluguLyric: 'ఆత్మీయ గానాలతో\n' +
            'నిన్నే ఆరాధన చేయనా\n' +
    ...
    {
        teluguTitle: 'ఆత్మల చెంతకు నడుపు బోధింపను నేర్పుము ప్రభువా',
        englishTitle: 'aathmala chemthaku nadupu boadhimpanu naerpumu prabhuvaa',
        teluguLyric: 'అను పల్లవి: ఆత్మల చెంతకు నడుపు బోధింపను నేర్పుము ప్రభువా\n' +
            'అను పల్లవి: మిత్రులు పాపములో బడిరి తమ మార్గము గానరు\n' +
            'అను పల్లవి: శ్రద్ధతో కాన రెవ్వరు ప్రార్థన జేయరు\n' +
            'అను పల్లవి: నా యెద జీవముతో నింపి ప్రార్థించను నేర్పుము\n',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆత్మలను సంపాదింపఁ నగు ఆత్మ బలమ',
        englishTitle: 'aathmalanu smpaadhimpao nagu',
        teluguLyric: 'ఆత్మలను సంపాదింపఁ నగు ఆత్మ బలమున నిది చేయనగు ఆత్మ\n' +
            'సంపాదనముకన్న నక్షయానందము లేదన్న యాత్మలను వెదకి రక్షింప\n' +
            'నాత్మల కాపరి యాన తిడి ||నాత్మలను||\n' +
            '\n' +
            '1. ధనముకన్న నాత్మ సంపా దనము మేలౌ దాని సంపా దనముఁ గోరి\n' +
            'మన రక్షకుఁడు ధారపోసెను దన రక్తంబు ||నాత్మలను||\n' +
            '\n' +
            '\n' +
            '2. క్షణక్షణము నెందఱో నశింప జాలిలేద నీవు సిఖింప అణఁకువతో\n' +
            'ననుదిన మొక యాత్మ నైన రక్షింపఁగ దయ రాదా ||యాత్మలను||\n' +
            '\n' +
            '\n' +
            '3. పరుల యాత్మ విమోచనంబు ప్రభువు కోరు బహుమానంబు పరదుఁ\n' +
            'డౌ క్రీస్తును నీవెట్లు వట్టి చేతులతో దర్శింతు ||నాత్మలను||\n' +
            '\n' +
            '\n' +
            '4. నీతిమార్గము ననుసరింప నిత్యమును జక్కఁగ వర్తింపఁ పాతకులఁ\n' +
            'ద్రిప్పెడు సద్భక్తుల్ జ్యోతులట్లు బ్రకాశించెద రిఁక ||నాత్మలను||\n' +
            '\n' +
            '\n' +
            '5. జీతనాతంబులు లేవని సిగ్గుపడకు మిది కాదని ప్రీతితో నాత్మలను\n' +
            'గడింప నీతి మహిమ మకుటంబులునౌ ||నాత్మలను||\n' +
            '\n' +
            '\n' +
            '6. నీ యమూల్య తరుణంబుల నీ ప్రశస్తదానంబుల వేయియేల నీ సర్వంబు\n' +
            'విభుని సేవకు నీ వర్పించు ||నాత్మలను||\n',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆది ప్రేమను విడచిపెట్టితివా ఓ నాదు ప్రియుడా మాదిరిగ జీవించ మానితివా',
        englishTitle: 'aadhi praemanu vidachipettithivaa oa naadhu priyudaa maadhiriga jeevimcha maanithivaa',
        teluguLyric: 'పల్లవి: ఆది ప్రేమను విడచిపెట్టితివా\n' +
    ...
    {
        teluguTitle: 'ఆదినములలో దేవోక్తి అరుదాయెను దేవునివార్త',
        englishTitle: 'aadhinamulaloa dhaevoakthi arudhaayenu dhaevunivaarth',
        teluguLyric: 'పల్లవి: ఆదినములలో దేవోక్తి - అరుదాయెను - దేవునివార్త\n' +
            'ఆదినములలో దేవోక్తి\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆదియంతము లేనివాడా సంపూర్ణుడగు మా దేవా',
        englishTitle: 'aadiyanthamu leni vaadaa sampoornudagu maa devaa ',
        teluguLyric: 'ఆదియంతము లేనివాడా సంపూర్ణుడగు మా దేవా\n' +
    ...
    {
        teluguTitle: ' ఆదరించిన యేసయ్యా ఆరాధనకు యోగ్యుడా\n',
        englishTitle: 'aadharinchina',
        teluguLyric: 'ఆదరించిన యేసయ్యా - ఆరాధనకు యోగ్యుడా - 2\n' +
            '\n' +
            'ఆరాధనకు తగినవాడా - 2\n' +
            '\n' +
            'ఆరాధనకు అర్హుడవయ్యా - 2\n' +
            '\n' +
            '\n' +
            '\n' +
            '\n' +
            '1. ఆదరణే లేక అల్లాడగా - ఆపద్భందువుగా అరుదెంచిన - 2\n' +
            '\n' +
            'ఆత్మ చేత ఆదరించిన - ఆత్మదేవా ఆరాధింతును - 2\n' +
            '\n' +
            '\n' +
            '\n' +
            '\n' +
            '2. ఆశ్రయమేలేక నేనుండగా - ఆపదలెన్నో ఆవరించిన - 2\n' +
            '\n' +
            'ఆలోచన చేత నడిపించిన - ఆరాధ్యుడ నిన్ను పూజింతును -2',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆదరింపుము యేసువా ని న్నాశ్రయిం',
        englishTitle: 'aadharimpumu yaesuvaa ni nnaas',
        teluguLyric: 'ఆదరింపుము యేసువా ని న్నాశ్రయించితి నా కికన్ లేదు వేరొక\n' +
            'యాశ్రయంబని లెస్సగా మది నమ్మితిన్ ||ఆద||\n' +
            '\n' +
            ...
            'లొసగుము నీతి నిధుల సజీవుడా ||ఆద||\n' +
            '\n' +
            '\n' +
            '3. ముందు వెనుకను దుష్ట శక్తుల మూక నన్నరి కట్టగన్ బంధితుండనైతి\n' +
            'నా ప ద్బాంధవ విడిపించుమా ||ఆద||\n' +
            '\n' +
            '\n' +
            '4. పరమ పురమున కరుగ నేరని పాలసుడనో రక్షకా కరుణతో నా\n' +
            'మొరను గైకొని కలుషముల నెడబాపవే ||ఆద||\n' +
            '\n' +
            '\n' +
            '5. పరమ ధాముడ వని యెరిగి నీ శరణు వేడితి నో ప్రభో తనువు\n' +
            'విడిచిన వేళలో నీ తలుపు నాకై తెరువు మా ||ఆద||',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆదిలో ఏమి లేనప్ప్పుడు',
        englishTitle: 'aadhilo emi lenappudu',
        teluguLyric: 'ఆదిలో ఏమి లేనప్ప్పుడు\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=urSeIZLN54M'
    },
    {
        teluguTitle: 'ఆధారం నాకు ఆధారం',
        englishTitle: 'aadhaaram naaku aadhaaram',
        teluguLyric: 'ఆధారం నాకు ఆధారం\n' +
    ...
    {
        teluguTitle: 'ఆధారం నాకు ఆధారం నాకు తోడు నీడైయున్న',
        englishTitle: 'aadhaarm naaku aadhaarm naaku thoadu needaiyunna',
        teluguLyric: 'ఆధారం నాకు ఆధారం - నాకు తోడు నీడైయున్న\n' +
            'నీ కృపయే ఆధారం - ఆశ్రయము నాకు ఆశ్రయము\n' +
            'ఆపత్కాలమందు నాకు - నీ నామం ఆశ్రయము\n' +
            'తల్లి తండ్రి లేకున్నా -బంధుజనము రాకున్నా\n' +
            'లోకమంత ఒక్కటైన - బాధలన్ని బంధువులైన\n' +
            '\n' +
            '1.బలహీన బంధంలో నేనుండగా\n' +
            'శ్రమల సంద్రంలో పడియుండగా\n' +
            'ఇరుకులో విశాలతను - కలిగించిన ఓ దేవా\n' +
            'నీ చల్లని ఒడిలో నన్ను చేర్చగరావా\n' +
            '\n' +
            '2.దారిద్య్రపు సుడి నుండి - ఐశ్వర్యపు తీరానికి\n' +
            'నీ స్వరమే నా వరమై - నడిపించిన యేసయ్యా\n' +
            'విడువను ఎడబాయనని - పలికిన దేవా\n' +
            '\n' +
            '3.దిగులుపడిన వేళలలో దరిచేరిన దేవా\n' +
            'అవమానపు చీకటిలో బలమిచ్చిన నా దేవా\n' +
            'చీకటిలో వెలుగువై నడిచొచ్చిన నా దేవా',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆధారం నీవేనయ్యా ఆధారం నీవేనయ్యా',
        englishTitle: 'adhaaram neevenayyaa',
        teluguLyric: 'ఆధారం నీవేనయ్యా ఆధారం నీవేనయ్యా\n' +
    ...
    {
        teluguTitle: 'ఆనంద గానాలతో ఆరాధించెద ఐశ్వర్యవంతుడా యేసయ్య',
        englishTitle: 'ananda ganalatho',
        teluguLyric: 'ఆనంద గానాలతో ఆరాధించెద ఐశ్వర్యవంతుడా యేసయ్య\n' +
            'అనురాగాలు కురిపించి అనువైన దీవెనలు ఇచ్చావని\n' +
            'ఆనంద నగరములో స్వాస్థ్యము నాకై దాచవని\n' +
            '\n' +
            '1. అరణ్య ప్రదేశములో నను కనుగొన్నావు\n' +
            'భీకర ధ్వని గల ఎడారిలో నా తోడున్నావు\n' +
            'నన్నావరించి పరామర్శించి కనుపాప వలె కాపాడినావు\n' +
            'నా శైలము నీవై నా దుర్గము నీవై\n' +
            'ఉన్నత స్థలములపై నను నిలిపావు\n' +
            '\n' +
            '2. నా మనో నేత్రములు వెలిగించియున్నావు\n' +
            'నీ శక్తి యొక్క మహాత్యములు తెలియజేసావు\n' +
            'ఆత్మాభిషేకముతో అభిషేకించి వాక్యోపదేశముతో బలపరిచావు\n' +
            'నా ధ్యానము నీవై నా ఆరాధనా నీవై\n' +
            'నీ పోలికగా నను మలుచుచున్నావు\n' +
            '\n' +
            '3. నీ జీవ గ్రంధములో నా పేరు రాసావు\n' +
            'నీ పరిశుద్ధలంకారముతో అలంకరించావు\n' +
            'నీ బూర శబ్దమును నే వినగానే నా శరీరము మార్పుచెందును\n' +
            'నా నిరీక్షణ నీవై నా మహిమా నీవై\n' +
            'తేజో వాసులతో నను చేర్చెదవు',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆనంద తైలాభిషేకము నిమ్ము ఆత్మ స్వరూపుడా',
        englishTitle: 'aananda thailaabhishekamu nimmu aathma swaroopudaa',
        teluguLyric: 'ఆనంద తైలాభిషేకము నిమ్ము – ఆత్మ స్వరూపుడా\n' +
    ...
    {
        teluguTitle: 'ఆనంద మగు ముక్తి యే నా మందిరము',
        englishTitle: 'aanmdha magu mukthi yae naa mm',
        teluguLyric: 'ఆనంద మగు ముక్తి యే నా మందిరము జ్ఞాని మానుగఁ జూచు\n' +
            'దాని సుందరము ||ఆనందమగు||\n' +
            '\n' +
            '1. పరదేశివలె దేహా వరణమం దుందున్ ధరణి కాననముగా దర్శించు\n' +
            'చుందున్ నెరి దుఃఖసుఖములు సరిగా భావింతున్ పరిశుద్ధాత్ముని వేఁ\n' +
            'డి పరితృప్తి నుండు ||నానంద మగు||\n' +
            '\n' +
            '\n' +
            '2. బహు శోధనలు నాపైఁ బడి వచ్చునపుడు నహితాంధతమము న\n' +
            'న్నడ్డుకొన్నపుడు నిహబాధ లన్నిన న్నెదిరించినపుడు నహహ యేసునివల్ల\n' +
            'నమృతుఁడ నెపుడు ||నానంద మగు||\n' +
            '\n' +
            '\n' +
            '3. ముందు నా మనసు దేవుని కప్పగింతు నందరి నస్మత్తు ల్యముగాఁ\n' +
            'ప్రేమింతున్ సందేహ రాహిత్య సరణిలో నిల్తుఁ పొందఁ బోయెడి ముక్తి\n' +
            'భువి యందె గాంతు ||నానంద మగు',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆనంద మానంద మానందమే ఆనంద మానందమే',
        englishTitle: 'aanmdha maanmdha maanmdhamae aanmdha maanmdhamae',
        teluguLyric: 'పల్లవి: ఆనంద మానంద మానందమే - ఆనంద మానందమే\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆనంద మహానందం ప్రభువే మనకానందం',
        englishTitle: 'aanmdha mahaanmdhm prabhuvae manakaanmdhm',
        teluguLyric: 'పల్లవి: ఆనంద మహానందం ప్రభువే మనకానందం\n' +
    ...
    {
        teluguTitle: 'ఆనంద యాత్ర ఇది ఆత్మీయ యాత్ర య',
        englishTitle: 'aanmdha yaathra idhi aathmeeya',
        teluguLyric: 'ఆనంద యాత్ర ఇది ఆత్మీయ యాత్ర\n' +
    ...
    {
        teluguTitle: 'ఆనంద సంద్రంబున నా జీవిత నావను',
        englishTitle: 'aanmdha smdhrmbuna naa jeevitha naavanu',
        teluguLyric: 'ఆనంద సంద్రంబున నా జీవిత నావను\n' +
            'నడిపేది ఆ యేసుడే దరిచేర్చు ఆ దేవుడే ||ఆనంద||\n' +
            '\n' +
            '1.పేనుగాలులే వీచినా తుఫానులే తరిమినా\n' +
            'గద్దించి కాపాడు ప్రభు అండ నీ కుండ\n' +
            'దిగులేల ఓ సోదరీ నిశ్చితగా సాగుమా ||ఆనంద||\n' +
            '\n' +
            '2.ఆప్తకాలమందునా రోదించి ప్రార్ధించినా\n' +
            'ఆదరణ లేదని దూషింపబోకుమా\n' +
            'ప్రభు చిత్తమనే గిన్నెనే సంతోషముగా త్రాగుము ||ఆనంద||\n' +
            '\n' +
            '3.ఏవైపు నీ మార్గము ఏవైపు నీ గమ్యము\n' +
            'ప్రభు సన్నిధిని వీడి పయనింప చూచి\n' +
            'మత్స్యంబు గర్భంబున నివసింపగోరెదవా ||ఆనంద||',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆనంద సంవత్సరం ఆశీర్వద కాలం',
        englishTitle: 'anamda samvatsaram',
        teluguLyric: 'ఆనంద సంవత్సరం ఆశీర్వద కాలం\n' +
    ...
    {
        teluguTitle: 'ఆనందం ఆనందం దినదినం ఆనందం యేస',
        englishTitle: 'aanmdhm aanmdhm dhinadhinm aan',
        teluguLyric: 'ఆనందం ఆనందం దినదినం ఆనందం\n' +
    ...
    {
        teluguTitle: 'ఆనందం నా కానందం ఆనందం పరమానందం',
        englishTitle: 'aanmdhm naa kaanmdhm aanmdhm paramaanmdhm',
        teluguLyric: '\n' +
            'అను పల్లవి: ఆనందం నా కానందం ఆనందం పరమానందం\n' +
            'అను పల్లవి: ఆత్మను శుద్ధిపర్చెను - నేత్రమువలె కాపాడును\n' +
            'అను పల్లవి: ఆడుదును నే పాడుదును - వెదకి వచ్చి నన్ను రక్షించెను',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: ' ఆనందం నీలోనే ఆధారం నీవేగా',
        englishTitle: 'aanandam neelone aadhaaram neevegaa',
        teluguLyric: 'ఆనందం నీలోనే – ఆధారం నీవేగా\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=DL5NKC0JMWU'
    },
    {
        teluguTitle: 'ఆనందం యేసుతో ఆనందం',
        englishTitle: 'aanandam yesutho',
        teluguLyric: 'ఆనందం యేసుతో ఆనందం\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆనందించెదము ప్రభు యేసులో అంతయు మరలార్జించు కొంటిమి',
        englishTitle: 'aanmdhimchedhamu prabhu yaesuloa amthayu maralaarjimchu komtimi',
        teluguLyric: '1. ఆనందించెదము - ప్రభు యేసులో - అంతయు మరలార్జించు కొంటిమి\n' +
    ...
    {
        teluguTitle: 'ఆనందించెదము యెహోవాలో అతిశయించును మాదు ఆత్మ',
        englishTitle: 'aanmdhimchedhamu yehoavaaloa athishayimchunu maadhu aathm',
        teluguLyric: 'పల్లవి: ఆనందించెదము యెహోవాలో\n' +
    ...
    {
        teluguTitle: 'ఆనందింతును నీలో దేవ అనుదినం నిన్ను స్తుతించుచు',
        englishTitle: 'aanandhinthunu neelo dheva',
        teluguLyric: 'ఆనందింతును నీలో దేవ - అనుదినం నిన్ను స్తుతించుచు\n' +
            '\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=StGYtRoN-sw'
    },
    {
        teluguTitle: 'ఆనందింతుము ఆనందింతుము',
        englishTitle: 'aanandinthumu aanandinthumu ',
        teluguLyric: 'ఆనందింతుము ఆనందింతుము\n' +
    ...
    {
        teluguTitle: 'ఆనందానందము మహదానందము',
        englishTitle: 'aanmdhaanmdhamu mahadhaanmdhamu',
        teluguLyric: '\n' +
            'అను పల్లవి: ఆనందానందము - మహదానందము\n' +
            'అను పల్లవి: యేసు ప్రభునకు - జయమని పాడు\n' +
            'అను పల్లవి: నాదు పాపమంతయు - తన శరీరమందు\n' +
            'అను పల్లవి: ప్రేమతోడ మోసె నాదు - ప్రియుడేసు రాజు\n' +
            'అను పల్లవి: నాకు బదులు మరణ మొంది - సమాధి యాయెను\n' +
            'అను పల్లవి: నాకై సమాధి నుండి - మరల లేచెను\n' +
            'అను పల్లవి: యేసు నావాడు - నే ప్రియుని వాడను - ఆనందానందము',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆనందమే ప్రభు యేసుని స్తుతించుట ఆత్మానంద గీతమే పాడెదా',
        englishTitle: 'aanandame prabhu yesuni',
        teluguLyric: 'ఆనందమే.... ప్రభు యేసుని స్తుతించుట -ఆత్మానంద గీతమే పాడెదా -2\n' +
            '\n' +
            'ఆనందమే...\n' +
            '\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆనందమే ప్రభు యేసుని స్తుతించుట',
        englishTitle: 'anamdame prabu',
        teluguLyric: 'ఆనందమే ప్రభు యేసుని స్తుతించుట\n' +
    ...
    {
        teluguTitle: 'ఆనందమే పరమానందమే యేసయ్య సన్నిధిలో',
        englishTitle: 'anandame paramaanandame',
        teluguLyric: 'ఆనందమే పరమానందమే యేసయ్య సన్నిధిలో\n' +
    ...
    {
        teluguTitle: 'ఆనందమే మనకిలలో మన కానందమే ప్రభు లేచెన్',
        englishTitle: 'aanmdhamae manakilaloa mana kaanmdhamae prabhu laechen',
        teluguLyric: 'పల్లవి: ఆనందమే మనకిలలో\n' +
    ...
    {
        teluguTitle: 'ఆనందమానంద మాయెను నాదు ప్రియకుమ',
        englishTitle: 'aanmdhamaanmdha maayenu naadhu',
        teluguLyric: 'ఆనందమానంద మాయెను నాదు ప్రియకుమారుని యందు\n' +
            '||మహదానం||\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆనందమానంద మాయెను నాదు ప్రియకుమారుని యందు',
        englishTitle: 'aanmdhamaanmdha maayenu naadhu priyakumaaruni ymdhu',
        teluguLyric: 'పల్లవి: ఆనందమానంద మాయెను - నాదు\n' +
    ...
    {
        teluguTitle: 'ఆనందమానందమే',
        englishTitle: 'aanandamaanandame',
        teluguLyric: 'ఆనందమానందమే\n' +
    ...
    {
        teluguTitle: 'ఆనందము ప్రభు నాకొసగెను',
        englishTitle: 'aanandamu prabhu naakosagenu',
        teluguLyric: 'ఆనందము ప్రభు నాకొసగెను\n' +
            'నా జీవితమే మారెను (2)\n' +
    ...
    {
        teluguTitle: 'ఆనందముగా యెహోవా నీ కృపలన్ని',
        englishTitle: 'aanandamugaa yehovaa nee krupaalanni ',
        teluguLyric: 'ఆనందముగా యెహోవా నీ కృపలన్ని\n' +
            'అన్ని కాలంబులందు కీర్తించెదన్ (2)\n' +
            '\n' +
            'చావు గోతినుండి లెవనెత్తి నాకు – జీవమిచ్చిన జీవ దాత\n' +
            'వివరింతు నే నీదు విశ్వాస్యత నెంతయో\n' +
            'సవ్యంబుగా ఈ భువియందున || అనందముగా ||\n' +
            '\n' +
            'సింహపు పిల్లలు – ఆకలిగొనిన- యెహొవ సహాయుడందరికి\n' +
            'ఇహమందునా ఏ మేలు కొదువ యుండదు\n' +
            'అహా! ఏమందు నీ విశ్వాస్యతన్ || అనందముగా ||\n' +
            '\n' +
            'ఎన్నెన్నో శోధన బాధలు రేగి – నన్ను కృంగదీయ పోరాడినన్\n' +
            'ఘనమైన నీ విశ్వాస్యతన్ నాకు చూపిన\n' +
            'కన్న తండ్రి నిన్ను కొనియాడెదన్ || అనందముగా ||\n' +
            '\n' +
            'పర్వతంబులు – పారిపోయినను- ఉర్విలోమార్పు కలిగిననూ\n' +
            'తరుణములు విరోధముగపై లేచినా –\n' +
            'స్మరియించెద నీ విశ్వాస్యతన్ || అనందముగా ||',
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=nfy-iOcCbwk'
    },
    {
        teluguTitle: 'ఆనందముతో ఆరాధింతున్ ఆత్మతోను సత్యముతో',
        englishTitle: 'aanmdhamuthoa aaraadhimthun aathmathoanu sathyamuthoa',
        teluguLyric: 'పల్లవి: ఆనందముతో - ఆరాధింతున్ ఆత్మతోను - సత్యముతో\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆనంధ మానంధ మాయెను – నాధు ప్రియ కుమారుని యంధు',
        englishTitle: 'aanandha maanandha maayenu',
        teluguLyric: 'ఆనంధ మానంధ మాయెను – నాధు ప్రియ కుమారుని యంధు\n' +
            'మహధానంధ మాయెను\n' +
            'ణా థనయుని మాత వినంది - సబ్ధ మొక్కతి ఆ మేఘం ఉలలో ఉధ్భవించెను\n' +
            'అధ్భుథముగ ంఅహధానంధ మాయెను\n' +
            '1. ప్రమించు చున్నావు నీథిని – ధుర్నీథిని ధ్వేషించి నావు – నీవు- అంధుచే\n' +
            'నీ థోతి వారి కంతె – ఆనంధ థైలముథో థంద్రి నిన్ను అధికంబుగా\n' +
            'అభిషేకించెను\n' +
            '\n' +
            '2.ఆంథ్య ధినముల యంధున – ఆ వింథ కుమారుని ధ్వారా ఐ మానవుల థోద\n' +
            'మాత్లాదెను – సర్వమునకు థంద్రి థనయుని వారసునిగా నియమించెను\n' +
            '\n' +
            '3. థనయుందె ఆ థంద్రి మహిమ – ఆ థథ్వంబు రూపంబు థానె ఆ –\n' +
            'మహాథ్యమైనత్తి – మాతల చేథ సమస్థం ఉను నిర్వహించు అంధరిలో అథి\n' +
            'స్రేష్తుందాయే\n' +
            '\n' +
            '4. నీవు నాధు కుమారుదవు – నిన్ను ప్రేమించి కన్నాను –నేను- నేదు ధందిగ\n' +
            'థనయుని ముధ్ధాదుది నిందుగ వాని నాస్రయించుది రంది రంది ధన్యులు కంది\n' +
            '\n' +
            '5. విజ్ఞాన సంపధ లెల్లను –ఆ సుజ్ఞానిలో గుప్థ మాయెన్ ఉ – ఆ సంథోషమును\n' +
            'పరిసుధ్ధథ – సమాధానము నీథి సక్థియు విమోచనమాయెను\n' +
            '\n' +
            '7. ధివ్య రాజైఅన కుమారుదు – ఒక వెయ్యి వర్షాలు పాలిన్ చును మహా – అంథము\n' +
            'లేని రాజ్య మేలును- యెంధరు జయంబు నొంధ్ధురో అంధరును పాలించెధరు',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆనంధం –ఆనంధం –ధినధినం ఆనంధం రారాజు నా స్వంతమాయెనే –',
        englishTitle: 'aanandham aanandham',
        teluguLyric: 'ఆనంధం –ఆనంధం –ధినధినం ఆనంధం రారాజు నా స్వంతమాయెనే –\n' +
            'యీ లోకమంధు శ్వంథ వాదాయెనే నా మధిలో స్వంథ మాయెను (2)\n' +
            'ఆ….ఆనంధమే – పరమానంధమే –ఎధి నా గొప్ప భాఘ్యమే ఈ లోకము నంధు.\n' +
            '\n' +
            '1. ఠొలి బాల్య వయసులో – నన్ను గుర్థించ్నాదు ఢూరం పోయిన కను గొన్నాదు (2)\n' +
            'థన ప్రానము ణా కర్పించి – జీవం పొంధుకొనుమని చెప్పెనూ\n' +
            '\n' +
            '2. ఏఎస్థిథిలోనైనా ప్రభు ప్రేమథో –నన్ను విదువక ఖాపాదును = నన్ను నమ్మి\n' +
            'యిచ్చిన భాధ్యథను ప్రభు వు వచ్చు వరకు కాచుకొంధునూ\n' +
            '\n' +
            '3. ప్రభువు వచ్చు ధినమున – థన చేయి చాపి ప్రే మథో = పిలిచి చేర్చు\n' +
            'కొనును – ప్రభువు సమూహ మ ంధు = అచ్చతాయనథో ఆది పాది సంథోషిన్\n' +
            'చెధన్',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    ...
    {
        teluguTitle: 'ఆన్ని కాలంబులనున్న యోహోవాని న్నెన్నథరంబయో కన్న థంద్రి – వన్నె',
        englishTitle: 'anni kalambula nunna yehova',
        teluguLyric: 'ఆన్ని కాలంబుల-నున్న యోహోవాని- న్నెన్నథరంబయో కన్న థంద్రి – వన్నె\n' +
            'కెక్కిన మోక్ష –వాసాలి సన్నుథు-లున్నథ మై యుంద మున్నె నీకు\n' +
            '\n' +
            '1 ణిన్ను ప్రకతన సేయ- నిఖిల లోకములను- బన్నుగ చేసిన బలుద వీవె = ఉన్న\n' +
            'లోకంబుల –నుదుగక కరునా సంపన్నథ థో నేలు-ప్రభుద వీవె- ఎన్న\n' +
            'సఖ్యము కాక – ఉన్న లక్షనముల సన్నుథించుతకు నే-చాలుదునా\n' +
            '\n' +
            '2 ఫుత్తింప నీవంచు- పోషింప నీవంచు-గిత్తింప నీవంచు – కీర్థింథును = వత్తి\n' +
            'పనికి మాలి నత్తి మానవులచే – పత్తి రక్షింప బా-ధ్యుంద వంచు = ధత్తమైన\n' +
            'క్రుపను దరి జేర్చ నాకిచ్చి –పత్తయి నిలచియుందు –ప్రభుద వంచు = కత్తదచే\n' +
            'గద-ముత్తుధనుక నా –పత్తుకొలధి నిన్ను ప్రస్థు థింథు\n' +
            '\n' +
            '3 ఖారున్య నిధి వీవు – కతినాథ్ముదను నేను- భూరి సుద్ధుదవీవు-పాపి నేను =\n' +
            'సార భాగ్యుద వీవు-జగథిలో నాకన్న దారిధ్రుదే లేదు- థరచి చూద = సార\n' +
            'సధ్గునముల – సంపన్నుదవు నీవు – ఘోర దుర్గున సం-చారి నేను = ఏ రీథి\n' +
            '\n' +
            'స్థుథి యింథు –నే రీథి సేవింథు - నేర మెన్నక ప్రోవ- నెరనమ్మిథి',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆనన్తము నున్డి అనన్తము వరకు జీవిన్చు ఢెవ',
        englishTitle: 'ananthamunundi ananthamu varaku',
        teluguLyric: 'ఆనన్తము నున్డి అనన్తము వరకు జీవిన్చు ఢెవ\n' +
            '\n' +
            'ణిత్యత్వము నున్డి, నిత్యత్వము వరకు నివసిన్చు ఢెవ\n' +
            '\n' +
            '\n' +
            'ఏఎ భువికి యెల్లలను నియమిన్చినావు\n' +
            '\n' +
            'సన్డ్రాలకు సరిహడ్దులు స్తపిన్చినావు\n' +
            'ణీ మహిమతొ నన్ను నిమ్పుము\n' +
            '\n' +
            'ణీ మహిమతొ నన్ను నిమ్పుము\n' +
            '\n' +
            '\n' +
            '\n' +
            '\n' +
            'ఛొరుస్ - ఆఅరడిన్తున్, ఆఅరడిన్తున్, ఆఅరదిన్తునూ ణిన్నె\n' +
            '\n' +
            '\n' +
            '\n' +
            '1. భూమ్యకశములు స్రుస్టిన్చినావు\n' +
            '\n' +
            'ణీ పొలికలొ నన్ను నిర్మిన్చినావు\n' +
            '\n' +
            '\n' +
            'ణీ చిట్తము నాలొ నెరవెర్చుము ఢెవ,\n' +
            '\n' +
            'ణీ కొరకై జీవిన్తును\n' +
            '\n' +
            '\n' +
            '\n' +
            '\n' +
            '2. Vఇశ్వమును నిరతమ్ పలిన్చువాడ\n' +
            '\n' +
            'ణీ హస్తముతొ నన్ను నడిపిన్చుము\n' +
            '\n' +
            '\n' +
            'ణీ రెక్కల వొడిలొనె నా క్శెమము ఢెవ\n' +
            '\n' +
            'ణా హ్రుడయము అర్పిన్తును',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆపత్కాలమున నాకు ఆశ్రయము నీవే',
        englishTitle: 'aapathkaalamuna naaku aashrayamu neeve',
        teluguLyric: 'ఆపత్కాలమున నాకు ఆశ్రయము నీవే\n' +
    ...
    {
        teluguTitle: ' ఆమెన్ హల్లెలుయా – యేసు క్రీస్తు కల్లెలుయా',
        englishTitle: 'amen halleluya',
        teluguLyric: 'ఆమెన్ హల్లెలుయా – యేసు క్రీస్తు కల్లెలుయా\n' +
    ...
    {
        teluguTitle: 'ఆయన కృప నిరంతరముండును',
        englishTitle: 'aayana krupa nirmtharamumdunu',
        teluguLyric: '1. యెహోవాను స్తుతించుడి ఆయన దయాళుడు\n' +
            '\n' +
            'పల్లవి: ఆయన కృప నిరంతరముండును\n' +
            'ఆయన కృప నిరంతరముండును\n' +
            'ఆయన కృప నిరంతరముండును\n' +
            '\n' +
            '2. దేవదేవునికి స్తుతులు చెల్లించుడి - ఆయన\n' +
            '\n' +
            '3. ప్రభువుల ప్రభువునకు స్తుతులు చెల్లించుడి - ఆయన\n' +
            '\n' +
            '4. ఆశ్చర్యకార్యముల చేయువాని స్తుతించుడి - ఆయన\n' +
            '\n' +
            '5. ఆకాశము జ్ఞనముచే జేసినవాని స్తుతించుడి - ఆయన\n' +
            '\n' +
            '6. నీళ్ళమీద భూమిని పరచినవాని స్తుతించుడి - ఆయన\n' +
            '\n' +
            '7. గొప్ప జ్యోతులు నిర్మించినవాని స్తుతించుడి - ఆయన\n' +
            '\n' +
            '8. పగటినేలు సూర్యుని చేసినవాని స్తుతించుడి - ఆయన\n' +
            '\n' +
            '9. రాత్రినేలు చంద్రుని చేసినవాని స్తుతించుడి - ఆయన',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆయెనె నా సంగీతము బలమైన కోటయును',
        englishTitle: 'ayane na sangeetham',
        teluguLyric: 'ఆయెనె నా సంగీతము - బలమైన కోటయును\n' +
            '\n' +
    ...
    {
        teluguTitle: 'ఆయనే నా సంగీతము బలమైన కోటయును',
        englishTitle: 'aayane naa sangeethamu balamaina kotayunu',
        teluguLyric: '\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=DEPpCPW6H7Q'
    },
    {
        teluguTitle: 'ఆయన నన్ను నడుపునను ఆలోచనే నా కాధారం',
        englishTitle: 'aayana nannu nadupunanu aaloachanae naa kaadhaarm',
        teluguLyric: '1. ఆయన నన్ను నడుపునను - ఆలోచనే నా కాధారం\n' +
    ...
    {
        teluguTitle: 'ఆయన నామము ఆశ్చర్యుడు ఆయన పేరాలోచనకర్త',
        englishTitle: 'aayana naamamu aashcharyudu aayana paeraaloachanakarth',
        teluguLyric: 'అను పల్లవి: ఆయన నామము ఆశ్చర్యుడు ఆయన పేరాలోచనకర్త\n' +
            'అను పల్లవి: బలమైన నిత్యుడునగు తండ్రి సమాధానకర్త నాయేసు\n' +
            'అను పల్లవి: బలమైన నిత్యుడునగు తండ్రి ఇమ్మానుయేల్ రక్షకు',
        englishLyric: '',
        details: '',
        youtubeLink: ''
    },
    {
        teluguTitle: 'ఆయనాశ్చర్య కరుడు నన్ను రక్షించి కాపాడి శుద్ధి చేయును',
        englishTitle: 'aayanaashcharya karudu nannu rakshimchi kaapaadi shudhdhi chaeyunu',
        teluguLyric: '\n' +
            '1. ఆయనాశ్చర్య కరుడు\n' +
    ...
    {
        teluguTitle: 'ఆరంభించెద యేసు నీలో ప్రతీదినం',
        englishTitle: 'arambinchedha yesu neelo prathi dhinam',
        teluguLyric: 'ఆరంభించెద యేసు నీలో ప్రతీదినం\n' +
    ...
    {
        teluguTitle: 'ఆరంభమయ్యింది రెస్టోరేషన్',
        englishTitle: 'aarambhamayyindi restoration',
        teluguLyric: 'ఆరంభమయ్యింది రెస్టోరేషన్\n' +
    ...
    {
        teluguTitle: 'ఆరాదించెదం ఆర్భాటించెదం',
        englishTitle: 'aaraadinchedham aarbhaatinchedham',
        teluguLyric: 'ఆరాదించెదం ఆర్భాటించెదం\n' +
        ...
        englishLyric: '',
        details: '',
        youtubeLink: 'https://www.youtube.com/watch?v=zvJym6zJa5A'
    },
    {
        teluguTitle: 'ఆరాదించెదను నిన్ను నా యేసయ్యా ఆత్మతో సత్యముతో',
        englishTitle: 'aaraadhimchedhanu ninnu naa yaesayyaa aathmathoa sathyamuthoa',
        teluguLyric: 'ఆరాదించెదను నిన్ను నా యేసయ్యా ఆత్మతో, సత్యముతో(2)\n' +
